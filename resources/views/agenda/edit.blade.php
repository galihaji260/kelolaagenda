        ...
        <div class="card card-primary">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              {!! Form::select('jenis', $jenisagenda, $agenda->jenis_agenda, ['class' => 'form-control']) !!}
              @error('jenis_agenda')
              <div class="alert alert-danger">{{ $message }}</div>
              @enderror
            </div>
            <div class="form-group">
              ...
              <input type="date" name="tanggal" class="form-control" id="tanggal" value="{{ $agenda->tanggal }}" placeholder="Tanggal Agenda">
              @error('tanggal')
              <div class="alert alert-danger">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" name="deskripsi_kegiatan" class="form-control" id="deskripsi_kegiatan" value="{{ $agenda->deskripsi_kegiatan }}"  placeholder="Deskripsi Kegiatan" required>
            ...
            <div class="form-group">
              ...
              {!! Form::select('status', $statuskegiatan, $agenda->status_kegiatan, ['class' => 'form-control']) !!}
              @error('status')
              <div class="alert alert-danger">{{ $message }}</div>
              @enderror
             </div>
