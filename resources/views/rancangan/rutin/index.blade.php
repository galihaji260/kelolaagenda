                ...
                <div class="card-body">
                    <form action="{{ route('rancanganrutin.yasinan') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 mb-2">
                                <input type="time" name="mulai" value="" placeholder="Mulai" class="form-control" required>
                            </div>
                            <div class="col-lg-2 mb-2">
                                <input type="time" name="selesai" value="" placeholder="Selesai" class="form-control" required>
                            </div>
                            <div class="col-lg-2 mb-2">
