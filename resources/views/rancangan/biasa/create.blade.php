            ...
            <div class="row">
              <div class="col-12">
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-5">
                      <input type="time" name="waktu_mulai" class="form-control" id="waktu" value="" placeholder="Mulai">
                    </div>
                    <div class ="col-2"> sampai </div>
                    <div class="col-5">
                      <input type="time" name="waktu_selesai" class="form-control" id="waktu" value="" placeholder="Selesai">
                    </div>
                  </div>
                  @error('waktu')
                  <div class="alert alert-danger">{{ $message }}</div>
