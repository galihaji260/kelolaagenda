                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" class="form-control" id="nama"
                                    value="{{ $anggota->nama }}" placeholder="Nama">
                            ...
                            <div class="form-group">
                                ...
                                <select id="divisi_id" name="divisi_id" class="form-control custom-select" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="no_hp" class="form-control" id="no_hp"
                                    value="{{ $anggota->no_hp }}" placeholder="No WA">
                                @error('no_hp')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="username" class="form-control" id="username"
                                    value="{{ $anggota->username }}" placeholder="Username" readonly required>
                                @error('username')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
