                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="pasaran" class="form-control" id="pasaran"
                                    value="{{ $pengisi_yasinan->pasaran }}" placeholder="Pasaran">
                                @error('pasaran')
                            ...
                            <div class="form-group">
                                <label for="personaldata_id">Pengisi Yasinan</label>
                                {!! Form::select('personaldata_id', $personalData, $pengisi_yasinan->personaldata_id, [
                                    'class' => 'form-control',
                                ]) !!}
                                @error('pengisi')
                                    <div class="alert alert-danger">{{ $message }}</div>
